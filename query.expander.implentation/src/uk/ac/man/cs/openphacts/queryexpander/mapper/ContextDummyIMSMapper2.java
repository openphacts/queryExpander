 ...
 * @author Christian
 */
public class ContextDummyIMSMapper2 implements IMSMapper{
    ...
    public List<URI> getSpecificMatchesForURI(URI uri, String graph) {
        ...
        if (graph.equals("http://www.example.org/graph1")){
            if (uri.stringValue().equals("http://www.foo.com/subj1")){
                results.add(valueFactory.createURI("http://www.foo.com/subj1"));
                results.add(valueFactory.createURI("http://www.foo.com/subj1a"));
            } else {
                results.add(valueFactory.createURI("http://www.foo.com/subj2"));
                results.add(valueFactory.createURI("http://www.foo.com/subj2a"));
            }             
            ...
            if (uri.stringValue().equals("http://www.foo.com/subj1")){
                ...
                results.add(valueFactory.createURI("http://www.bar.com/2a"));
            }             
        } else {
