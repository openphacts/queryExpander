...
public class Version2Loader extends QueryCaseLoader{
   ...
   private void loadSparql2_6() {
        ...
        queryCase.replaceQuery = "PREFIX foaf:   <http://xmlns.com/foaf/0.1/> \n"
                ...
                + "       || ?x = <http://info.identifiers.org/drugbank/DB00398> \n"
                + "       || ?x = <http://linkedchemistry.info/chembl/molecule/m276734> \n"
                + "       || ?x = <http://rdf.chemspider.com/187440> \n"
                + "       || ?x = <http://www.chemspider.com/187440> \n"
                + "       || ?x = <http://www.chemspider.com/Chemical-Structure.187440> \n"
                + "       || ?x = <http://www.chemspider.com/Chemical-Structure.187440.html> \n"
                + "       || ?x = <http://www.chemspider.com/Chemical-Structure.187440.rdf> \n"
                + "       || ?x = <http://www.conceptwiki.org/concept/38932552-111f-4a4e-a46a-4ed1d7bdf9d5> \n"
                + "       || ?x = <http://www.conceptwiki.org/concept/index/38932552-111f-4a4e-a46a-4ed1d7bdf9d5> \n"
                + "       || ?x = <http://www.conceptwiki.org/web-ws/concept/get?uuid=38932552-111f-4a4e-a46a-4ed1d7bdf9d5> \n"
                + "       || ?x = <http://www.drugbank.ca/drugs/DB00398> \n"
